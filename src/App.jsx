    ...
    <div className="app">
      ...
      <section className="palace-guide">
        <div className="container">
          ...
          <div className="court-section">
            ...
            <div className="subsection">
              ...
              <div className="subsection-content">
                <img src="/images/IMG_8041.JPG" alt="Topkapi Palace Treasury with incredible imperial treasures and jewels" className="subsection-image" />
                <p>
            ...
            <div className="subsection">
              ...
              <div className="subsection-content">
                <img src="/images/IMG_8043.jpg" alt="The famous 86-carat Spoonmaker's Diamond" className="subsection-image" />
                <p>
          ...
          <div className="court-section">
            ...
            <div className="court-content">
              <img src="/images/IMG 0608 from Google Account.jpg" alt="Fourth Court gardens with elegant kiosks and peaceful pavilions" className="court-image" />
              <div className="court-text">
                <p>
            ...
            <div className="subsection">
              <h4>Baghdad Kiosk</h4>
              <div className="subsection-content">
                <img src="/images/IMG_8076.jpg" alt="Baghdad Kiosk with spectacular Golden Horn view" className="subsection-image" />
                <p>
            ...
            <div className="subsection">
              ...
              <div className="subsection-content">
                <img src="/images/IMG_0603.jpg" alt="Spectacular Bosphorus Strait view from Topkapi Palace gardens" className="subsection-image" />
                <p>
        ...
        <div className="container">
          ...
          <div className="harem-grid">
            <div className="harem-card">
              <img src="/images/4858E3B8-A95B-46BA-98AD-329040D56AF7.jpg" alt="Concubines' living quarters in the Harem" className="harem-image" />
            ...
            <div className="harem-card">
              <img src="/images/IMG_8070.jpg" alt="Beautiful Iznik tiles with tulip and carnation patterns" className="harem-image" />
            ...
            <div className="harem-card">
              <img src="/images/IMG_0623.jpg" alt="Imperial Hall where the Sultan held banquets" className="harem-image" />
              <h3>Imperial Hall</h3>
              <p>
      ...
      <section className="conclusion">
        <div className="container">
          ...
          <img src="/images/Istanbul Bosphorus.jpg" alt="Stunning view of Istanbul and the Bosphorus from Topkapi Palace" className="conclusion-image" />
        </div>
      </section>
    </div>
  )
